...
const Navbar = () => {
    ...
    return (
      ...
      text-gray-800'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in block ${open ? 'top-18 ' : 'top-[-490px]'}`}>
